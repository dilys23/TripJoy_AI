...
{{
    "trip_plans": [
        {{
            "date": "Ngày tháng",
            "details": [
                {{"time_range": "Khung giờ", "location": "Tên địa điểm cụ thể", "province_city": "Tên tỉnh thành phố","activity": "Hoạt động", "cost": Chi phí}}
            ]
        }}
    ]
}}
...
{{
    "trip_plans": [
        {{
            "date": "05/12/2024",
            "details": [
                {{"time_range": "7h-8h", "location": "Khách sạn Anantara Hội An", "province_city": "Hội An", "activity": "Ăn sáng", "cost": 200000}},
                {{"time_range": "9h-11h", "location": "Bãi biển Mỹ Khê" , "province_city": "Đà Nẵng", "activity": "Tham quan", "cost": 0}},
                {{"time_range": "12h-13h", "location": "Nhà hàng Bé Mặn", "province_city": "Đà Nẵng" ,"activity": "Ăn trưa", "cost": 300000}},
                {{"time_range": "14h-16h", "location": "Hội An Impression Theme Park", "province_city": "Hội An", "activity": "Tham quan", "cost": 100000}},
                {{"time_range": "16h-17h", "location": "Quán Cà Phê The Espresso Station", "province_city": "Hội An", "activity": "Uống cà phê", "cost": 50000}},
                {{"time_range": "18h-20h", "location": "Nhà hàng đặc sản Mì Quảng Bà Hường", "activity": "Ăn tối", "cost": 150000}},
                {{"time_range": "20h+", "location": "Khách sạn Anantara Hội An", "province_city": "Hội An", "activity": "Nghỉ ngơi", "cost": 0}}
            ]
        }},
        {{
            "date": "06/12/2024",
            "details": [
                {{"time_range": "7h-8h", "location": "Khách sạn Anantara Hội An", "province_city": "Hội An", "activity": "Ăn sáng", "cost": 200000}},
                {{"time_range": "9h-11h", "location": "Chùa Cầu", "province_city": "Hội An", "activity": "Tham quan", "cost": 0}},
                {{"time_range": "12h-13h", "location": "Nhà hàng Quán Cơm", "province_city": "Hội An","activity": "Ăn trưa", "cost": 150000}},
                {{"time_range": "14h-16h", "location": "Hội An Impression Theme Park", "province_city": "Hội An", "activity": "Tham quan", "cost": 100000}},
                {{"time_range": "16h-17h", "location": "Quán Cà Phê Faifo", "province_city": "Hội An", "activity": "Uống cà phê", "cost": 50000}},
                {{"time_range": "18h-20h", "location": "Nhà hàng Hải Sản Sông Hàn", "province_city": "Hội An", "activity": "Ăn tối", "cost": 200000}},
                {{"time_range": "20h+", "location": "Khách sạn Anantara Hội An", "province_city": "Hội An", "activity": "Nghỉ ngơi", "cost": 0}}
            ]
        }},
        {{
            "date": "07/12/2024",
            "details": [
                {{"time_range": "7h-8h", "location": "Khách sạn Novotel Đà Nẵng", "province_city": "Đà Nẵng",  "activity": "Ăn sáng", "cost": 200000}},
                {{"time_range": "9h-11h", "location": "Bà Nà Hills", "province_city": "Đà Nẵng",  "activity": "Tham quan", "cost": 500000}},
                {{"time_range": "12h-13h", "location": "Nhà hàng Phở Quảng", "province_city": "Đà Nẵng",  "activity": "Ăn trưa", "cost": 100000}},
                {{"time_range": "14h-16h", "location": "Bảo tàng Đà Nẵng", "province_city": "Đà Nẵng",  "activity": "Tham quan", "cost": 100000}},
                {{"time_range": "16h-17h", "location": "Quán Cà Phê 43", "province_city": "Đà Nẵng",  "activity": "Uống cà phê", "cost": 50000}},
                {{"time_range": "18h-20h", "location": "Nhà hàng Làng Nướng", "province_city": "Đà Nẵng",  "activity": "Ăn tối", "cost": 200000}},
                {{"time_range": "20h+", "location": "Khách sạn Novotel Đà Nẵng", "province_city": "Đà Nẵng",  "activity": "Nghỉ ngơi", "cost": 0}}
            ]
        }}
    ]
}}
"""
    ...
    try:
        ...
        with open("trip_plans_recommend.csv", mode="w", encoding="utf-8", newline="") as file:
            ...
            writer.writerow(["Ngày", "Khung giờ", "Địa điểm","Tỉnh thành phố", "Hoạt động", "Chi phí"])
